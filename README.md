...
- [Homeio](https://homeio.app/) - Desktop-style home server manager with app store, terminal, file manager and real-time system metrics. Compatible with CasaOS app store archives. ([Source Code](https://github.com/doctor-io/homeio)) `MIT` `TypeScript/Docker`
